    ...
    return number_format($res, 2, ",", ".");
        ...
        <div class="w-full mx-4 my-4">
            <div class="flex flex-col">
                <div class="mt-4">
                    <h4 class="text-xl font-bold text-gray-600 align-baseline">Digipos/Direct Sales</h4>
                    ...
                    <div class="overflow-hidden bg-white rounded-md shadow w-fit">
                        <table class="text-left border-collapse w-fit">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-200">
                                    <td class="p-3 font-bold text-gray-700 border border-b">{{ $key+1 }}</td>
                                    <td class="p-3 text-gray-700 uppercase border border-b cluster">{{ $data->cluster }}</td>
                                    <td class="p-3 text-gray-700 uppercase border border-b outlet">{{ $data->outlet_id }}</td>
                                    <td class="p-3 text-gray-700 uppercase border border-b outlet">{{ $data->fisik }}</td>
