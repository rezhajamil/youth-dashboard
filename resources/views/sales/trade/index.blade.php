...
<div class="w-full mx-4 my-4">
    <div class="flex flex-col">
        <div class="mt-4">
            <h4 class="text-xl font-bold text-gray-600 align-baseline">Trade In</h4>
            <span class="text-sm">Update : {{ $update[0]->last_update }}</span>
            <div class="flex justify-between mt-4">
                <form class="flex flex-wrap items-center mt-4 gap-x-4 gap-y-2" action="{{ route('sales.trade') }}" method="get">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="p-4 text-gray-700 border-b">
                                <form action="{{ route('sales.trade.destroy',$data->msisdn) }}" method="post">
                                    @csrf
                                    @method('delete')
