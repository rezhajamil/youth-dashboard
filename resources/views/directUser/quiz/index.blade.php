...
<div class="w-full mx-4">
    <div class="flex flex-col">
        <div class="mt-4">
            ...
            <a href="{{ route('quiz.create') }}" class="inline-block px-4 py-2 my-2 font-bold text-white bg-y_premier rounded-md hover:bg-y_premier"><i class="mr-2 fa-solid fa-plus"></i> Data Quiz Baru</a>
            @endif
                    ...
                    <tbody class="max-h-screen overflow-y-auto">
                        ...
                        <tr class="border-b hover:bg-gray-200">
                            ...
                            <td class="p-4 text-gray-700 gap-x-3">
                                <div class="">
                                    <a href="{{ route('quiz.show',$data->id) }}" class="block my-1 text-base font-semibold text-y_premier transition hover:text-indigo-800">Lihat</a>
