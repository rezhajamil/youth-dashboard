...
<div class="lg:flex lg:h-full lg:flex-col">
    <header class="flex items-center justify-between px-6 py-4 border-b border-gray-200 lg:flex-none">
        ...
        <div class="flex items-center">
          ...
          -->
                    <div class="absolute right-0 z-10 mt-3 overflow-hidden origin-top-right bg-white rounded-md shadow-lg w-36 ring-1 ring-black ring-opacity-5 focus:outline-none"
                ...
                <button type="button"
                    class="px-3 py-2 ml-6 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Add
                    event</button>
            </div>
          ...
          Leaving: "transition ease-in duration-75"
            ...
            To: "transform opacity-0 scale-95"
        -->
                <div class="absolute right-0 z-10 mt-3 overflow-hidden origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg w-36 ring-1 ring-black ring-opacity-5 focus:outline-none"
    ...
    <div class="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col">
          ...
          -->
                        ...
                        <li>
                            <a href="#" class="flex group">
                                ...
                                <time datetime="2022-01-03T10:00"
                                    class="flex-none hidden ml-3 text-gray-500 group-hover:text-indigo-600 xl:block">10AM</time>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex group">
                                ...
                                <time datetime="2022-01-03T14:00"
                                    class="flex-none hidden ml-3 text-gray-500 group-hover:text-indigo-600 xl:block">2PM</time>
                            </a>
                        </li>
                    </ol>
                </div>
                ...
                <div class="relative px-3 py-2 bg-white">
                    <time datetime="2022-01-12"
                        class="flex items-center justify-center w-6 h-6 font-semibold text-white bg-indigo-600 rounded-full">12</time>
                    <ol class="mt-2">
                        <li>
                            <a href="#" class="flex group">
                                <p class="flex-auto font-medium text-gray-900 truncate group-hover:text-indigo-600">
                        ...
                        <li>
                            <a href="#" class="flex group">
                                ...
                                <time datetime="2022-01-22T15:00"
                                    class="flex-none hidden ml-3 text-gray-500 group-hover:text-indigo-600 xl:block">3PM</time>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex group">
                                ...
                                <time datetime="2022-01-22T19:00"
                                    class="flex-none hidden ml-3 text-gray-500 group-hover:text-indigo-600 xl:block">7PM</time>
                            </a>
                        </li>
                    </ol>
                </div>
                        ...
                        <li>
                            <a href="#" class="flex group">
                                ...
                                <time datetime="2022-02-04T21:00"
                                    class="flex-none hidden ml-3 text-gray-500 group-hover:text-indigo-600 xl:block">9PM</time>
                            </a>
                        </li>
                    </ol>
                </div>
        ...
        -->
                <button type="button"
                    class="flex flex-col px-3 py-2 text-gray-500 h-14 bg-gray-50 hover:bg-gray-100 focus:z-10">
                    <!--
          ...
          -->
                ...
                <button type="button"
                    class="flex flex-col px-3 py-2 text-gray-900 bg-white h-14 hover:bg-gray-100 focus:z-10">
                ...
                <button type="button"
                    class="flex flex-col px-3 py-2 font-semibold text-indigo-600 bg-white h-14 hover:bg-gray-100 focus:z-10">
                ...
                <button type="button"
                    class="flex flex-col px-3 py-2 font-semibold text-white bg-white h-14 hover:bg-gray-100 focus:z-10">
                    <time datetime="2022-01-22"
                        class="flex items-center justify-center w-6 h-6 ml-auto bg-gray-900 rounded-full">22</time>
                    <span class="sr-only">2 events</span>
                    <span class="-mx-0.5 mt-auto flex flex-wrap-reverse">
                        <span class="mx-0.5 mb-1 h-1.5 w-1.5 rounded-full bg-gray-400"></span>
                        <span class="mx-0.5 mb-1 h-1.5 w-1.5 rounded-full bg-gray-400"></span>
