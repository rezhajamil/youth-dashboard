...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 overflow-y-auto transition duration-300 transform w-fit bg-slate-600 lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-10" x-data="{sales:false,direct:false,school:false,broadcast:false,content:false,event:false,market:false,location:false}">
        <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-opacity-25 bg-slate-800" href="{{ URL::to('/dashboard') }}">
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="content" x-transition>
            <a href="{{ route('sapaan.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Sapaan</span></a>
            <a href="{{ route('challenge.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Challenge</span></a>
            <a href="{{ route('slide.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Slide Show</span></a>
            <a href="{{ route('schedule.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Schedule</span></a>
            <a href="{{ route('notification.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Notification</span></a>
            <a href="{{ route('news.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">News</span></a>
            <a href="{{ route('category.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Category</span></a>
        </div>
        @endif
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="direct" x-transition>
            <a href="{{ route('direct_sales.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Resume Direct</span></a>
            <a href="{{ route('direct_user.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Detail Direct</span></a>
            <a href="{{ route('direct_user.absensi') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Absensi</span></a>
            @if (Auth::user()->privilege=='superadmin')
            <a href="{{ route('quiz.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Quiz</span></a>
            @endif
            <a href="{{ route('survey.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Survey</span></a>
            <a href="{{ route('direct_user.clock_in') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Clock In</span></a>
            <a href="{{ route('direct_user.kpi') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">KPI</span></a>
        </div>
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="location" x-transition>
            <a href="{{ route('location.taps') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">TAPS</span></a>
            <a href="{{ route('location.poi') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">POI</span></a>
        </div>
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="market" x-transition>
            <a href="{{ route('survey.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Survey</span></a>
            <a href="{{ route('survey.lucky_draw') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Lucky Draw</span></a>
        </div>
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="school" x-transition>
            <a href="{{ route('sekolah.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Database</span></a>
            <a href="{{ route('sekolah.resume') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Resume</span></a>
            <a href="{{ route('sekolah.pjp') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">PJP</span></a>
            <a href="{{ route('sekolah.oss_osk') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">OSS OSK</span></a>
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="broadcast" x-transition>
            <a href="{{ route('broadcast.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Data Broadcast</span></a>
            <a href="{{ route('broadcast.call') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Data Call</span></a>
            @if (auth()->user()->privilege!='cluster')
            <a href="{{ route('campaign.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Wording</span></a>
            <a href="{{ route('whitelist.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Whitelist</span></a>
            @endif
        </div>
        ...
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800" x-show="event" x-transition>
            <a href="{{ route('event.index') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Peserta</span></a>
            <a href="{{ route('event.resume') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Resume Peserta</span></a>
            <a href="{{ route('event.absen') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Absensi</span></a>
            <a href="{{ route('event.challenge') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Challenge</span></a>
            <a href="{{ route('event.poin_history') }}" class="text-white transition-all border-b hover:bg-white hover:text-slate-800 border-b-slate-400"><span class="inline-block px-2 py-3">Poin History</span></a>
        </div>
        @endif
