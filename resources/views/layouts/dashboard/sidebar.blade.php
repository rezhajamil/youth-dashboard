...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    class="fixed inset-y-0 left-0 z-30 overflow-y-auto transition duration-300 transform w-fit bg-slate-600 lg:static lg:inset-0 lg:translate-x-0">
    ...
    <nav class="mt-10" x-data="{ sales: false, kpi: false, direct: false, school: false, broadcast: false, content: false, event: false, market: false, location: false, channel: false, halo: false, travel: false }">
        ...
        @if (auth()->user()->privilege == 'superadmin')
            ...
            <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800"
                ...
                <a href="{{ route('sapaan.index') }}"
                    class="text-white transition-all border-b select-none border-b-slate-400 hover:bg-white hover:text-slate-800"><span
        ...
        <a class="flex items-center px-6 py-2 mt-4 text-white transition-all cursor-pointer hover:bg-slate-800 hover:bg-opacity-25 hover:text-gray-100"
            x-on:click="travel=!travel">
            <i class="w-6 fa-solid fa-plane"></i>
            <span class="mx-3 text-white select-none">Travel</span>
            <i class="inline-block ml-auto text-white transition-transform transform fa-solid fa-angle-right"
                :class="{ 'rotate-90': travel, 'rotate-0': !travel }"></i>
        </a>
        <div class="flex flex-col w-3/4 mx-6 mt-2 ml-auto overflow-hidden bg-opacity-25 rounded-md bg-slate-800"
            x-show="travel" x-transition>
            <a href="{{ route('travel.index') }}"
                class="text-white transition-all border-b select-none border-b-slate-400 hover:bg-white hover:text-slate-800"><span
                    class="inline-block px-2 py-3">List Travel</span></a>
            <a href="{{ route('travel.keberangkatan') }}"
                class="text-white transition-all border-b select-none border-b-slate-400 hover:bg-white hover:text-slate-800"><span
                    class="inline-block px-2 py-3">Keberangkatan</span></a>
        </div>
