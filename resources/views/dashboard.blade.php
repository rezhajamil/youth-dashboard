    ...
    <div class="flex flex-wrap -mx-6">
        <div class="w-full px-6 sm:w-1/2 xl:w-1/4">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $userAO }}</h4>
                    <div class="text-gray-500">User AO</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/4 xl:mt-0">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $userYBA }}</h4>
                    <div class="text-gray-500">User YBA</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/4 xl:mt-0">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $userORBIT }}</h4>
                    <div class="text-gray-500">User ORBIT</div>
                </div>
            </div>
        </div>

        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/4">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                <div class="p-3 bg-opacity-75 rounded-full bg-cyan-600">
                    <svg class="w-8 h-8 text-white" viewBox="0 0 28 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.2 9.08889C18.2 11.5373 16.3196 13.5222 14 13.5222C11.6804 13.5222 9.79999 11.5373 9.79999 9.08889C9.79999 6.64043 11.6804 4.65556 14 4.65556C16.3196 4.65556 18.2 6.64043 18.2 9.08889Z" fill="currentColor" />
                        <path d="M25.2 12.0444C25.2 13.6768 23.9464 15 22.4 15C20.8536 15 19.6 13.6768 19.6 12.0444C19.6 10.4121 20.8536 9.08889 22.4 9.08889C23.9464 9.08889 25.2 10.4121 25.2 12.0444Z" fill="currentColor" />
                        <path d="M19.6 22.3889C19.6 19.1243 17.0927 16.4778 14 16.4778C10.9072 16.4778 8.39999 19.1243 8.39999 22.3889V26.8222H19.6V22.3889Z" fill="currentColor" />
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $userPROMOTOR }}</h4>
                    <div class="text-gray-500">User PROMOTOR</div>
                </div>
            </div>
        </div>

        <div class="w-full px-6 my-6 sm:w-1/2 xl:w-1/4">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                <div class="p-3 bg-opacity-75 rounded-full bg-amber-600">
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $pjp }}</h4>
                    <div class="text-gray-500">PJP</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full px-6 my-6 sm:w-1/2 xl:w-1/4">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                <div class="p-3 bg-opacity-75 rounded-full bg-emerald-600">
                    <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"></path>
                    </svg>
                </div>
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $nonPjp }}</h4>
                    <div class="text-gray-500">NON PJP</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full px-6 my-6 sm:w-1/2 xl:w-1/4">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                <div class="p-3 bg-opacity-75 rounded-full bg-violet-600">
                    <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"></path>
                    </svg>
                </div>
                ...
                <div class="mx-5">
                    <h4 class="text-2xl font-semibold text-gray-700">{{ $oss_osk }}</h4>
                    <div class="text-gray-500">OSS OSK</div>
                </div>
            </div>
        </div>
    </div>
