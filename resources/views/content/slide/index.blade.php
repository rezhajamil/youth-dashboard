...
<div class="w-full mx-4">
    <div class="flex flex-col">
        <div class="mt-4">
            <h4 class="mb-2 text-xl font-bold text-gray-600 align-baseline">Content Management - Slide Show</h4>
            <a href="{{ route('slide.create') }}" class="inline-block px-4 py-2 my-2 font-bold text-white bg-y_premier rounded-md hover:bg-y_premier"><i class="mr-2 fa-solid fa-plus"></i> Data Slide Show Baru</a>
                ...
                <table class="overflow-auto text-left border-collapse w-fit">
                    <thead class="border-b">
                        <tr>
                            ...
                            <th class="p-3 text-sm font-medium text-gray-100 uppercase bg-y_tersier">Gambar</th>
                    ...
                    <tbody class="max-h-screen overflow-y-auto">
                        ...
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="p-4 text-gray-700 border-b">
                                ...
                                <form action="{{ route('slide.destroy',$data->id) }}" method="post">
                                    @csrf
                                    @method('delete')
