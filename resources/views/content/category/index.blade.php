...
<div class="w-full mx-4">
    <div class="flex flex-col">
        <div class="mt-4">
            ...
            <a href="{{ route('category.create') }}" class="inline-block px-4 py-2 my-2 font-bold text-white bg-indigo-600 rounded-md hover:bg-indigo-800"><i class="mr-2 fa-solid fa-plus"></i> Data Kategori Baru</a>
                ...
                <table class="overflow-auto text-left border-collapse w-fit">
                    <thead class="border-b">
                        <tr>
                            ...
                            <th class="p-3 text-sm font-medium text-gray-100 uppercase bg-red-600">Detail</th>
                            <th class="p-3 text-sm font-medium text-gray-100 uppercase bg-red-600">Keterangan</th>
                            <th class="p-3 text-sm font-medium text-gray-100 uppercase bg-red-600">Harga</th>
