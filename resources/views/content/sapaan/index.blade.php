...
<div class="w-full mx-4">
    <div class="flex flex-col">
        <div class="mt-4">
            ...
            <a href="{{ route('sapaan.create') }}" class="inline-block px-4 py-2 my-2 font-bold text-white bg-indigo-600 rounded-md hover:bg-indigo-800"><i class="mr-2 fa-solid fa-plus"></i> Data Sapaan Baru</a>
