...
<div class="w-full mx-4">
    <div class="flex flex-col">
        <div class="mt-4">
            <h4 class="mb-2 text-xl font-bold text-gray-600 align-baseline">Content Management - Sapaan</h4>
            <a href="{{ route('sapaan.create') }}" class="inline-block px-4 py-2 my-2 font-bold text-white bg-y_premier rounded-md hover:bg-y_premier"><i class="mr-2 fa-solid fa-plus"></i> Data Sapaan Baru</a>
                ...
                <table class="overflow-auto text-left border-collapse w-fit">
                    <thead class="border-b">
                        <tr>
                            ...
                            <th class="p-3 text-sm font-medium text-gray-100 uppercase bg-y_tersier">Sapaan</th>
