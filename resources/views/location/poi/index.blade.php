...
@section('body')
    <div class="w-full mx-4">
        <div class="flex flex-col">
            <div class="mt-4">
                <h4 class="text-xl font-bold text-gray-600 align-baseline">Data POI</h4>
                    ...
                    <table class="overflow-auto text-left border-collapse w-fit">
                        <thead class="border-b">
                            <tr>
                                ...
                                <th class="text-gray-100-=-09 bg-y_tersier p-3 text-sm font-medium uppercase">Location</th>
                        ...
                        <tbody>
                            @foreach ($poi as $key => $data)
                                <tr class="hover:bg-gray-200">
                                    ...
                                    <td class="p-3 text-gray-700 uppercase border-b sub_branch">{{ $data->sub_branch }}</td>
                                    ...
                                    <td class="p-3 text-gray-700 uppercase border-b">{{ $data->location }}</td>
